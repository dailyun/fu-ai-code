...
import com.dali.fuaicodecommon.common.DeleteRequest;
...
public class AppController {
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(com.dali.fuaicode.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
